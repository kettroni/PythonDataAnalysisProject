...
df_restaurant_contact_rating = pd.read_json(PATH + 'restaurant_contact_rating.json')
...
df_contact_opinions = pd.read_json(PATH + 'contact_opinions.json')
